...
<body>
				...
				<div
					...
					<form class="form-horizontal" action="${pageContext.request.contextPath}/UserServlet" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" id="inputPassword3" name="vericode"
									placeholder="请输入验证码">
							</div>
							<div class="col-sm-3">
	...
	<script>
		/* window.onload=function(){
			var autoLoginEle=document.getElementsByName("autoLogin")[0];
			//alert(autoLoginEle.nodeType)
			autoLoginEle.onclick=function(){
				alert(this.checked);
			}
		} */
	</script>
